    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_client', models.BooleanField(default=True, help_text='Help easily distinguish users and perform queries.Clents are the main type of user.', verbose_name='client status')),
